...
(custom-set-variables
 ...
 '(package-selected-packages
   '(rustic go-mode company-lsp haskell-mode git-gutter-fringe lsp-ui lsp-mode 2048-game ess monokai racket-mode evil-surround alda-mode docker treemacs-icons-dired treemacs-magit treemacs-evil treemacs-projectile treemacs ranger hydra clj-refactor terraform-mode feature-mode poet poet-theme sly darkroom origami tldr green-is-the-newblack-theme green-is-the-new-black-theme multi-term writeroom-mode rainbow-mode cider clojure-mode dashboard alchemist nov counsel groovy-mode org-bullets smex evil-matchit symon projectile fireplace python-docstring gitignore-mode ag apache-mode elixir-mode mmm-mode popwin color-identifiers-mode highlight-indent-guides telephone-line yaml-mode dockerfile-mode all-the-icons neotree gh-md arduino-mode evil-magit async magit flycheck latex-preview-pane ## python-doctring web-mode markdown-mode js2-mode evil goto-chg undo-tree which-key use-package))
